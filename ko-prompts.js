...
`;
  ...
  function _publicNinePointPrompt(ctx, o) {
    ...
    return KI_ANTI_HALLUZINATION
      ...
      + 'SCHRITT 2 (ZEITREIHEN-/DAUERHAFTIGKEITS-SPRACHE, Regel e — belegter '
      + 'Wiederholungsfund 05.09.2026: die reine Prinzip-Anweisung in Regel '
      + 'e allein reichte nicht, "stabil" trat im selben Live-Test DREIMAL '
      + 'auf, in Abschnitt 1, 2 UND 4): gehe JEDEN Satz der fertig '
      + 'formulierten Antwort durch und suche gezielt nach "stabil"/"stabile"'+
      '/"stabiler"/"stabiles"/"stabilisiert"/"Stabilität"/"Stabilisierung" '
      + 'sowie sinnverwandten Wörtern (robuster, verankert, gefestigt, '
      + 'nachhaltig, anhaltend, Trendfestigkeit o.ä.). Prüfe bei JEDEM Fund: '
      + 'bezieht sich das Wort auf einen EINZELNEN Datenpunkt zu EINEM '
      + 'Zeitpunkt (z.B. ein VIX-Wert, ein Regime-Label, ein Grade, ein '
      + 'EMA-Abstand)? Wenn ja, MUSS das Wort vor Abgabe entfernt oder durch '
      + 'eine reine Zustandsbeschreibung ersetzt werden (z.B. "stabiles '
      + 'Umfeld" → "das aktuelle Regime", "stabilem Grade-B-Profil" → '
      + '"Grade-B-Profil", OHNE das Adjektiv "stabil").\n'
