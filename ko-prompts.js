    ...
    return KI_ANTI_HALLUZINATION
      ...
      + (istOptions
          ? ('SCHRITT 3 (PFLICHT-ZUSÄTZE OPTIONSSTRATEGIEN, 18.09.2026 — '
             ...
             + 'nicht nur implizit im Ticker-Kontext stehen lässt. Fehlt '
             + 'einer der beiden Pflicht-Zusätze, MUSS er vor Abgabe ergänzt '
             + 'werden — NICHT als nachträgliche Ergänzung nach Abschnitt 9, '
             + 'sondern an der dafür vorgesehenen Stelle in Abschnitt 3/4.\n')
          : '')
