...
`;
  ...
  function _publicNinePointPrompt(ctx, o) {
    ...
    return KI_ANTI_HALLUZINATION
      ...
      + 'e) SEMANTISCHE VERSTÄRKER OHNE MODELLVARIABLE (04.09.2026, Reviewer-'
      + 'Kernprinzip, zweiter Retest — deckt Synonym-Umgehungen von Regel a/d '
      + 'ab, z.B. "erhöht die Sensitivität" statt "erhöhtes Risiko", "spricht '
      + 'für prolongierte Rücksetzer" statt "wahrscheinlicher"): folgende '
      + 'Wörter/Wendungen ERHÖHTE PRÜFPFLICHT, wenn sie aus EINEM einzelnen '
      + 'numerischen Merkmal abgeleitet werden — bestätigt, signalisiert, '
      ...
      + 'STABIL/STABILITÄT — UND ALLE FLEXIONSFORMEN (05.09.2026 ergänzt, '
      + 'inzwischen VIERFACH belegter Fund CSP-Live-Tests: "strukturelle '
      + 'Stabilität", "stabile Trenddefinition", "stabiles ... Aufwärts-'
      + 'trending", "stabilem EMA200-Abstand", "stabilerem Prämienbasis-'
      + 'Umfeld", "langfristig stabilisierte Lage" — WICHTIG: die Wortliste '
      + 'gilt für JEDE Flexionsform, nicht nur die Grundform "stabil": '
      + 'stabil, stabile, stabiler, stabiles, stabilste[r], stabilisiert, '
      + 'stabilisierte, Stabilisierung, Stabilität. Ein einzelner Snapshot-'
      + 'Wert OHNE Zeitreihen-Vergleich kann per Definition nicht "stabil" '
      + 'sein, das ist ein Kategorienfehler: Stabilität ist eine Aussage '
      + 'über Veränderung/Konstanz ÜBER ZEIT, ein Momentaufnahme-Wert zeigt '
      + 'nur einen Zustand zu EINEM Zeitpunkt. BESONDERS STRENG bei "lang-'
      + 'fristig" in Kombination mit einem kurzfristigen Einzelindikator '
      + '(belegter Fund: "eine kurzfristig schwache, aber langfristig '
      + 'stabilisierte Lage" — aus einem einzelnen RSI-Wert abgeleitet, der '
      + 'per Definition NUR eine kurzfristige Größe misst; "langfristig" '
      + 'ist hier komplett unbelegt und darf nie aus einem kurzfristigen '
      + 'Indikator wie RSI gefolgert werden). Diese '
      ...
      + '(Ebene 1). Für "stabil"/"Stabilität" (in jeder Flexionsform) gilt '
      + 'zusätzlich (iii): NUR verwenden, wenn tatsächlich mehrere Zeit-'
      + 'punkte/eine Zeitreihe verglichen werden (z.B. ein mehrfach '
      + 'bestätigter Trendverlauf) — NIEMALS für einen einzelnen Snapshot-'
      + 'Wert (Kurs, EMA-Abstand, RSI etc.) zu einem Zeitpunkt. NIEMALS als '
      + 'eigenständige Aussage über '
      ...
      + abschnitt8
      + abschnitt9
      + '\nSCHLUSS-SELBSTPRÜFUNG (05.09.2026, wiederholter Fund trotz Regel f '
      + '— PFLICHT vor Abgabe der Antwort): liste innerlich die Ticker auf, '
      + 'die in Abschnitt 3 genannt wurden (sowohl Top-Titel als auch '
      + 'Nicht-Top-Titel). Prüfe DANACH jeden einzelnen Ticker, der in den '
      + 'Abschnitten 4 bis 9 vorkommt, gegen diese Liste — kommt dort ein '
      + 'Ticker vor, der NICHT auf der Abschnitt-3-Liste steht, MUSS er vor '
      + 'Abgabe entfernt oder der Satz umformuliert werden. Diese Prüfung '
      + 'gilt unabhängig davon, ob der zusätzliche Ticker plausibel ins '
      + 'Argument passt.\n'
